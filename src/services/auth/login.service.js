...
/**
 * Device tracking + JWT issuance shared by normal login and MiniGen verify-login.
 */
...
async function login(req, res) {
  ...
  try {
    ...
    return finalizeLogin(user, deviceInfo, req, res);
  } catch (err) {
...
module.exports = { login, finalizeLogin };
